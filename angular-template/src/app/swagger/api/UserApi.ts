...
export class UserApi {
     ...
     * @param id 
     */
    public usersIdDelete(id: string, extraHttpRequestParams?: any): Observable<models.Success> {
     ...
     * @param id 
     */
    public usersIdGet(id: number, extraHttpRequestParams?: any): Observable<models.ForumUser> {
     ...
     * @param body 
     */
    public usersIdPut(id: string, body?: models.ForumUser, extraHttpRequestParams?: any): Observable<models.ForumUser> {
        return this.usersIdPutWithHttpInfo(id, body, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param body 
     */
    public usersIdPutWithHttpInfo(id: string, body?: models.ForumUser, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/users/${id}`;
